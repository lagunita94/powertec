...
const ContactPage = () => {
    ...
    <section className={containerStyles.section_1}>
        <div style={{flex:'1 1 50%'}} className={containerStyles.office}>
            <h1 className={containerStyles.back_text}>Offices</h1>
            <h1 style={{color: "#0e132a",fontWeight: "700",fontSize: "70px"}}>Our Offices</h1>
            <div className={containerStyles.card}>
                <div className={containerStyles.card_header}>Chennai</div>
                <img className={containerStyles.office_image} src={chennai} alt="office"/>
                <div className={containerStyles.card_content}>
                <h2>Powertec House</h2>
                    <p>No. 4, 5<sup>th</sup> Main Road, Vijayanagar</p>
                    <p>Velachery, Chennai -600042</p>
                    <p>Tel: 044-2259-1731/3467/3572</p>
                    <p>Fax: 044-2259-1726</p>
                    <p>Email:<a href="mailto:powertecchn@powertecindia.com">powertecchn@powertecindia.com</a></p>
                </div>
            </div>
            <div className={containerStyles.card}>
                <div className={containerStyles.card_header}>Delhi</div>
                <img className={containerStyles.office_image} src={delhi} alt="office"/>
                <div className={containerStyles.card_content}>
                <h2>Powertec House</h2>
                    ...
                    <p>Email:<a href="mailto:powertecdel@powertecindia.com">powertecdel@powertecindia.com</a></p>
                </div>
            </div>
        </div>
